...
flowerTl.to('.down', { y: -innerHeight / 2, autoAlpha: 0 }, 'stem')
...
flowerTl.to('.flower-container', { y: -innerHeight / 2, autoAlpha: 0 })
...
gsap.set('[data-birth]', { scale: 0, x: innerWidth / 2, y: innerHeight / 2, rotation: -180 })
